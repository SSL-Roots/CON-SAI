...
class PlayTheirPrePenalty(Play):
    def __init__(self):
        super(PlayTheirPrePenalty, self).__init__('PlayTheirPrePenalty')

        self.applicable = "THEIR_PRE_PENALTY"
        self.done_aborted = "THEIR_PRE_PENALTY"
